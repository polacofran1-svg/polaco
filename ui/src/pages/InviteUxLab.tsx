...
function LabSection({
  ...
  return (
    <section
      className={cn(
        "rounded-4xl border border-border/70 bg-background/80 p-4 shadow-[0_24px_60px_rgba(15,23,42,0.08)] sm:p-5",
        accentClassName,
      )}
    >
...
function StatusCard({
  ...
  return (
    <Card className={cn("rounded-3xl shadow-none", toneClassName)}>
...
function InviteLandingShell({
  ...
  return (
    <div className="overflow-hidden rounded-4xl border border-zinc-800 bg-zinc-950 shadow-[0_30px_80px_rgba(2,6,23,0.55)]">
...
function AuthScreenPreview({ mode, error }: { mode: "sign_in" | "sign_up"; error?: string }) {
  return (
    <div className="overflow-hidden rounded-4xl border border-border/70 bg-background shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
...
export function InviteUxLab() {
  return (
    <div className="space-y-6">
      <div className="overflow-hidden rounded-5xl border border-border/70 bg-[linear-gradient(135deg,rgba(8,145,178,0.10),transparent_28%),linear-gradient(180deg,rgba(245,158,11,0.10),transparent_44%),var(--background)] shadow-[0_30px_80px_rgba(15,23,42,0.10)]">
